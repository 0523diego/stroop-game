...
namespace StroopGame
{
    ...
    public class DifficultyManager : MonoBehaviour
    {
        ...
        [Tooltip("每階段需要的正確答題數才能進階")]
        public int trialsToAdvancePerStage = 8;
        ...
        public bool RegisterCorrect()
        {
            ...
            if (CorrectInCurrentStage >= trialsToAdvancePerStage
        ...
        public string GetStageDisplayName()
        {
            return CurrentStage switch
            {
                DifficultyStage.Stage1_Training => "第一關：訓練之地",
                DifficultyStage.Stage2_Mixed => "第二關：幻術森林",
                DifficultyStage.Stage3_TimePressure => "第三關：魔王城",
                _ => "未知"
            };
        }
    }
